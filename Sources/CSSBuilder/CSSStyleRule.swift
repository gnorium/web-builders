...
public func selector(_ s1: String, _ s2: String, @CSSOMBuilder _ content: () -> [CSSRule]) -> CSSStyleRule {
	CSSStyleRule(" \(s1), \(s2)", content)
}

public func selector(_ s1: String, _ s2: String, _ s3: String, @CSSOMBuilder _ content: () -> [CSSRule]) -> CSSStyleRule {
	CSSStyleRule(" \(s1), \(s2), \(s3)", content)
}

public func selector(_ t1: TagName, _ t2: TagName, @CSSOMBuilder _ content: () -> [CSSRule]) -> CSSStyleRule {
	CSSStyleRule(" \(t1.value), \(t2.value)", content)
}

public func selector(_ t1: TagName, _ t2: TagName, _ t3: TagName, @CSSOMBuilder _ content: () -> [CSSRule]) -> CSSStyleRule {
	CSSStyleRule(" \(t1.value), \(t2.value), \(t3.value)", content)
}

public func selector(_ t1: TagName, _ t2: TagName, _ t3: TagName, _ t4: TagName, @CSSOMBuilder _ content: () -> [CSSRule]) -> CSSStyleRule {
	CSSStyleRule(" \(t1.value), \(t2.value), \(t3.value), \(t4.value)", content)
}

public func selector(_ t1: TagName, _ t2: TagName, _ t3: TagName, _ t4: TagName, _ t5: TagName, @CSSOMBuilder _ content: () -> [CSSRule]) -> CSSStyleRule {
	CSSStyleRule(" \(t1.value), \(t2.value), \(t3.value), \(t4.value), \(t5.value)", content)
}

public func selector(_ t1: TagName, _ t2: TagName, _ t3: TagName, _ t4: TagName, _ t5: TagName, _ t6: TagName, @CSSOMBuilder _ content: () -> [CSSRule]) -> CSSStyleRule {
	CSSStyleRule(" \(t1.value), \(t2.value), \(t3.value), \(t4.value), \(t5.value), \(t6.value)", content)
}

@available(*, deprecated, renamed: "CSSStyleRule")
public func ruleset(_ selector: String, @CSSOMBuilder _ content: () -> [CSSRule] = { [] }) -> CSSStyleRule {
	CSSStyleRule(selector, content)
}
...
public func attribute(_ selector: String, _ pseudoClass: CSSPseudoClass, @CSSOMBuilder _ content: () -> [CSSRule]) -> CSSStyleRule {
	CSSStyleRule("[\(selector)]\(pseudoClass.rawValue)", content)
}

/// Attribute selector combined with pseudo-class
/// Example: attribute(ariaPressed(true), .hover) { ... }
public func attribute(_ pseudoClass: CSSPseudoClass, _ selector: String, @CSSOMBuilder _ content: () -> [CSSRule]) -> CSSStyleRule {
	CSSStyleRule("[\(selector)]\(pseudoClass.rawValue)", content)
}

/// Attribute selector with just a pseudo-class (for simple attributes like [disabled])
/// Example: attribute(.disabled) { ... }
public func attribute(_ pseudoClass: CSSPseudoClass, @CSSOMBuilder _ content: () -> [CSSRule]) -> CSSStyleRule {
...
public func attribute(_ selector: String, _ p1: CSSPseudoClass, _ p2: CSSPseudoClass, @CSSOMBuilder _ content: () -> [CSSRule]) -> CSSStyleRule {
...
public func attribute(_ selector: String, _ p1: CSSPseudoClass, _ p2: CSSPseudoClass, _ p3: CSSPseudoClass, @CSSOMBuilder _ content: () -> [CSSRule]) -> CSSStyleRule {
...
public func attribute(_ selector: String, _ pseudoClass: CSSPseudoClass, _ combinator: String, @CSSOMBuilder _ content: () -> [CSSRule]) -> CSSStyleRule {
...
public func attribute(_ selector: String, _ pseudoClass: CSSPseudoClass, _ c1: String, _ c2: String, @CSSOMBuilder _ content: () -> [CSSRule]) -> CSSStyleRule {
...
@_disfavoredOverload
public func descendant(_ s1: String, _ s2: String, @CSSOMBuilder _ content: () -> [CSSRule]) -> [CSSStyleRule] {
	let rules = content()
	return [CSSStyleRule(" \(s1)", { rules }), CSSStyleRule(" \(s2)", { rules })]
}

/// Descendant combinator with three selectors
@_disfavoredOverload
public func descendant(_ s1: String, _ s2: String, _ s3: String, @CSSOMBuilder _ content: () -> [CSSRule]) -> [CSSStyleRule] {
	let rules = content()
	return [CSSStyleRule(" \(s1)", { rules }), CSSStyleRule(" \(s2)", { rules }), CSSStyleRule(" \(s3)", { rules })]
}
...
public func descendant(_ attrSelector: String, _ selector: String, @CSSOMBuilder _ content: () -> [CSSRule]) -> CSSStyleRule {
	CSSStyleRule(" \(attrSelector) \(selector)", content)
}
...
@_disfavoredOverload
public func child(_ s1: String, _ s2: String, @CSSOMBuilder _ content: () -> [CSSRule]) -> [CSSStyleRule] {
	let rules = content()
	return [CSSStyleRule(" > \(s1)", { rules }), CSSStyleRule(" > \(s2)", { rules })]
}
...
@_disfavoredOverload
public func child(_ s1: String, _ s2: String, _ s3: String, @CSSOMBuilder _ content: () -> [CSSRule]) -> [CSSStyleRule] {
	let rules = content()
	return [CSSStyleRule(" > \(s1)", { rules }), CSSStyleRule(" > \(s2)", { rules }), CSSStyleRule(" > \(s3)", { rules })]
}
...
public func child(_ attrSelector: String, _ selector: String, @CSSOMBuilder _ content: () -> [CSSRule]) -> CSSStyleRule {
	CSSStyleRule(" \(attrSelector) > \(selector)", content)
}
...
public func nextSibling(_ selector: String, @CSSOMBuilder _ content: () -> [CSSRule]) -> CSSStyleRule {
	CSSStyleRule(" + \(selector)", content)
}

/// Next sibling combinator with attribute selector
/// Example: nextSibling(attribute("checked"), ".icon")
public func nextSibling(_ attrSelector: String, _ selector: String, @CSSOMBuilder _ content: () -> [CSSRule]) -> CSSStyleRule {
	CSSStyleRule(" \(attrSelector) + \(selector)", content)
}
...
public func subsequentSibling(_ selector: String, @CSSOMBuilder _ content: () -> [CSSRule]) -> CSSStyleRule {
	CSSStyleRule(" ~ \(selector)", content)
}

/// Subsequent sibling combinator with attribute selector
/// Example: subsequentSibling(attribute("disabled"), ".label")
public func subsequentSibling(_ attrSelector: String, _ selector: String, @CSSOMBuilder _ content: () -> [CSSRule]) -> CSSStyleRule {
	CSSStyleRule(" \(attrSelector) ~ \(selector)", content)
}
