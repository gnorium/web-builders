...
public struct HTMLBodyElement: HTMLElement, Sendable, CustomStringConvertible {
	...
	public func callAsFunction(@HTMLBuilder content: () -> [any HTML]) -> HTMLBodyElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [any CSS]) -> HTMLBodyElement {
...
public func body(@HTMLBuilder content: () -> [any HTML] = { [] }) -> HTMLBodyElement {
