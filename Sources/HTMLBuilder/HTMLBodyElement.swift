...
public struct HTMLBodyElement: HTMLElement, Sendable, CustomStringConvertible {
	...
	public func callAsFunction(@HTMLBuilder _ content: () -> [HTML]) -> HTMLBodyElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [CSS]) -> HTMLBodyElement {
...
public func body(@HTMLBuilder _ content: () -> [HTML] = { [] }) -> HTMLBodyElement {
