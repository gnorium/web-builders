...
public struct HTMLBodyElement: HTMLElementProtocol, Sendable, CustomStringConvertible {
	...
	public func callAsFunction(@HTMLBuilder content: () -> [any HTMLProtocol]) -> HTMLBodyElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [any CSSProtocol]) -> HTMLBodyElement {
...
public func body(@HTMLBuilder content: () -> [any HTMLProtocol] = { [] }) -> HTMLBodyElement {
