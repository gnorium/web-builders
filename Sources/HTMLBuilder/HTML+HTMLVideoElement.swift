...
extension HTML {
  public class HTMLVideoElement: HTML.HTMLMediaElement, @unchecked Sendable {
...
extension HTML.HTMLVideoElement {
...
public func video(@HTMLBuilder content: () -> [DOM.Node] = { [] }) -> HTML.HTMLVideoElement {
  HTML.HTMLVideoElement(content: content)
}
