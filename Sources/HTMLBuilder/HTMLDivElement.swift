...
public struct HTMLDivElement: HTMLElement, Sendable, CustomStringConvertible {
	...
	public func callAsFunction(@HTMLBuilder _ content: () -> [HTML]) -> HTMLDivElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [CSS]) -> HTMLDivElement {
...
public func div(@HTMLBuilder _ content: () -> [HTML] = { [] }) -> HTMLDivElement { HTMLDivElement(content: content) }
