...
public struct HTMLOListElement: HTMLElementProtocol, Sendable, CustomStringConvertible {
	...
	public func callAsFunction(@HTMLBuilder content: () -> [any HTMLProtocol]) -> HTMLOListElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [any CSSProtocol]) -> HTMLOListElement {
...
public func ol(@HTMLBuilder content: () -> [any HTMLProtocol] = { [] }) -> HTMLOListElement { HTMLOListElement(content: content) }
