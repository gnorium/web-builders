...
public struct HTMLIFrameElement: HTMLElementProtocol, Sendable, CustomStringConvertible {
	...
	public func callAsFunction(@HTMLBuilder content: () -> [any HTMLProtocol]) -> HTMLIFrameElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [any CSSProtocol]) -> HTMLIFrameElement {
...
public func iframe(@HTMLBuilder content: () -> [any HTMLProtocol] = { [] }) -> HTMLIFrameElement {
