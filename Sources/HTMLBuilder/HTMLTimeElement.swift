...
public struct HTMLTimeElement: HTMLElementProtocol, Sendable, CustomStringConvertible {
	...
	public func callAsFunction(@HTMLBuilder content: () -> [any HTMLProtocol]) -> HTMLTimeElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [any CSSProtocol]) -> HTMLTimeElement {
...
public func time(@HTMLBuilder content: () -> [any HTMLProtocol] = { [] }) -> HTMLTimeElement {
