...
public struct HTMLTextAreaElement: HTMLElement, Sendable, CustomStringConvertible {
	...
	public func callAsFunction(@HTMLBuilder _ content: () -> [HTML]) -> HTMLTextAreaElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [CSS]) -> HTMLTextAreaElement {
...
public func textarea(@HTMLBuilder _ content: () -> [HTML] = { [] }) -> HTMLTextAreaElement { HTMLTextAreaElement(content: content) }
