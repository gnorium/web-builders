...
public struct HTMLInputElement: HTMLElementProtocol, Sendable, CustomStringConvertible {
...
extension HTMLInputElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [any CSSProtocol]) -> HTMLInputElement {
