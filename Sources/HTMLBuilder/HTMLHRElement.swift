...
public struct HTMLHRElement: HTMLElementProtocol, Sendable, CustomStringConvertible {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [any CSSProtocol]) -> HTMLHRElement {
