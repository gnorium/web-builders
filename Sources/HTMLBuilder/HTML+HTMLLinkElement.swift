...
extension HTML.HTMLLinkElement {
  ...
  public func rel(_ values: HTML.Link.Rel...) -> Self { addingAttribute("rel", values.map { $0.rawValue }.joined(separator: " ")) }
  ...
  public func crossorigin(_ value: HTML.Link.CrossOrigin) -> Self { addingAttribute("crossorigin", value.rawValue) }
  public func `as`(_ value: String) -> Self { addingAttribute("as", value) }
  public func `as`(_ value: HTML.Link.As) -> Self { addingAttribute("as", value.rawValue) }
}

public func link() -> HTML.HTMLLinkElement { HTML.HTMLLinkElement() }
