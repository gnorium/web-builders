...
public struct HTMLDListElement: HTMLElementProtocol, Sendable, CustomStringConvertible {
	...
	public func render(indent: Int = 0) -> String {
		...
		let openElement = "<dl\(attributeString)>"
		let closeElement = "</dl>"
	...
	public func callAsFunction(@HTMLBuilder content: () -> [any HTMLProtocol]) -> HTMLDListElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [any CSSProtocol]) -> HTMLDListElement {
...
public func dl(@HTMLBuilder content: () -> [any HTMLProtocol] = { [] }) -> HTMLDListElement {
