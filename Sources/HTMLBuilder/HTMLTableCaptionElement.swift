...
public struct HTMLTableCaptionElement: HTMLElement, Sendable, CustomStringConvertible {
	...
	public func callAsFunction(@HTMLBuilder _ content: () -> [HTML]) -> HTMLTableCaptionElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [CSS]) -> HTMLTableCaptionElement {
...
public func caption(@HTMLBuilder _ content: () -> [HTML] = { [] }) -> HTMLTableCaptionElement {
