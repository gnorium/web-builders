...
public struct HTMLUListElement: HTMLElementProtocol, Sendable, CustomStringConvertible {
	...
	public func render(indent: Int = 0) -> String {
		...
		let openElement = "<ul\(attributeString)>"
		let closeElement = "</ul>"
	...
	public func callAsFunction(@HTMLBuilder content: () -> [any HTMLProtocol]) -> HTMLUListElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [any CSSProtocol]) -> HTMLUListElement {
...
public func ul(@HTMLBuilder content: () -> [any HTMLProtocol] = { [] }) -> HTMLUListElement { HTMLUListElement(content: content) }
