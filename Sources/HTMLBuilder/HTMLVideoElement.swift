...
public struct HTMLVideoElement: HTMLElement, Sendable, CustomStringConvertible {
	...
	public func callAsFunction(@HTMLBuilder content: () -> [any HTML]) -> HTMLVideoElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [any CSS]) -> HTMLVideoElement {
...
public func video(@HTMLBuilder content: () -> [any HTML] = { [] }) -> HTMLVideoElement {
