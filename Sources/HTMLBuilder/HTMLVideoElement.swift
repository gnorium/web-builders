...
public struct HTMLVideoElement: HTMLElement, Sendable, CustomStringConvertible {
	...
	public func callAsFunction(@HTMLBuilder _ content: () -> [HTML]) -> HTMLVideoElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [CSS]) -> HTMLVideoElement {
...
public func video(@HTMLBuilder _ content: () -> [HTML] = { [] }) -> HTMLVideoElement {
