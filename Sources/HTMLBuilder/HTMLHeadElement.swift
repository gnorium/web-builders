...
public struct HTMLHeadElement: HTMLElement, Sendable, CustomStringConvertible {
	...
	public func callAsFunction(@HTMLBuilder _ content: () -> [HTML]) -> HTMLHeadElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [CSS]) -> HTMLHeadElement {
...
public func head(@HTMLBuilder _ content: () -> [HTML] = { [] }) -> HTMLHeadElement {
