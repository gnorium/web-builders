...
public struct HTMLFieldSetElement: HTMLElementProtocol, Sendable, CustomStringConvertible {
	...
	public func render(indent: Int = 0) -> String {
		...
		let openElement = "<fieldset\(attributeString)>"
		let closeElement = "</fieldset>"
	...
	public func callAsFunction(@HTMLBuilder content: () -> [any HTMLProtocol]) -> HTMLFieldSetElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [any CSSProtocol]) -> HTMLFieldSetElement {
	...
	public func form(_ value: String) -> HTMLFieldSetElement {
...
public func fieldset(@HTMLBuilder content: () -> [any HTMLProtocol] = { [] }) -> HTMLFieldSetElement {
