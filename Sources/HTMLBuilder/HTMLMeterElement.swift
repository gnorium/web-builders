...
public struct HTMLMeterElement: HTMLElement, Sendable, CustomStringConvertible {
	...
	public func callAsFunction(@HTMLBuilder _ content: () -> [HTML]) -> HTMLMeterElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [CSS]) -> HTMLMeterElement {
...
public func meter(@HTMLBuilder _ content: () -> [HTML] = { [] }) -> HTMLMeterElement {
