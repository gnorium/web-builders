...
public struct HTMLMeterElement: HTMLElementProtocol, Sendable, CustomStringConvertible {
	...
	public func callAsFunction(@HTMLBuilder content: () -> [any HTMLProtocol]) -> HTMLMeterElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [any CSSProtocol]) -> HTMLMeterElement {
...
public func meter(@HTMLBuilder content: () -> [any HTMLProtocol] = { [] }) -> HTMLMeterElement {
