...
extension HTML.HTMLOptionElement {
...
public func option(_ text: String? = nil) -> HTML.HTMLOptionElement { HTML.HTMLOptionElement(text) }
public func option(@HTMLBuilder content: () -> [DOM.Node]) -> HTML.HTMLOptionElement {
  HTML.HTMLOptionElement(content: content)
}
