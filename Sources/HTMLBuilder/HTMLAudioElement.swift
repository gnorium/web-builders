...
public struct HTMLAudioElement: HTMLElementProtocol, Sendable, CustomStringConvertible {
	...
	public func callAsFunction(@HTMLBuilder content: () -> [any HTMLProtocol]) -> HTMLAudioElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [any CSSProtocol]) -> HTMLAudioElement {
	...
	public func preload(_ value: String) -> HTMLAudioElement {
...
public func audio(@HTMLBuilder content: () -> [any HTMLProtocol] = { [] }) -> HTMLAudioElement {
