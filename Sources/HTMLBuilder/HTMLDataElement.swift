...
public struct HTMLDataElement: HTMLElement, Sendable, CustomStringConvertible {
	...
	public func callAsFunction(@HTMLBuilder _ content: () -> [HTML]) -> HTMLDataElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [CSS]) -> HTMLDataElement {
...
public func data(@HTMLBuilder _ content: () -> [HTML] = { [] }) -> HTMLDataElement {
