...
public struct HTMLDataElement: HTMLElement, Sendable, CustomStringConvertible {
	...
	public func callAsFunction(@HTMLBuilder content: () -> [any HTML]) -> HTMLDataElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [any CSS]) -> HTMLDataElement {
...
public func data(@HTMLBuilder content: () -> [any HTML] = { [] }) -> HTMLDataElement {
