...
public struct HTMLDataElement: HTMLElementProtocol, Sendable, CustomStringConvertible {
	...
	public func callAsFunction(@HTMLBuilder content: () -> [any HTMLProtocol]) -> HTMLDataElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [any CSSProtocol]) -> HTMLDataElement {
...
public func data(@HTMLBuilder content: () -> [any HTMLProtocol] = { [] }) -> HTMLDataElement {
