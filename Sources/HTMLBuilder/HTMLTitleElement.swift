...
public struct HTMLTitleElement: HTMLElement, Sendable, CustomStringConvertible {
	...
	public func callAsFunction(@HTMLBuilder _ content: () -> [HTML]) -> HTMLTitleElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [CSS]) -> HTMLTitleElement {
...
public func title(@HTMLBuilder _ content: () -> [HTML] = { [] }) -> HTMLTitleElement {
