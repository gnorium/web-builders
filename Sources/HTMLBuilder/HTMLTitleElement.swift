...
public struct HTMLTitleElement: HTMLElement, Sendable, CustomStringConvertible {
	...
	public func callAsFunction(@HTMLBuilder content: () -> [any HTML]) -> HTMLTitleElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [any CSS]) -> HTMLTitleElement {
...
public func title(@HTMLBuilder content: () -> [any HTML] = { [] }) -> HTMLTitleElement {
