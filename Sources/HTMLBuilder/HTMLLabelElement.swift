...
public struct HTMLLabelElement: HTMLElement, Sendable, CustomStringConvertible {
	...
	public func callAsFunction(@HTMLBuilder content: () -> [any HTML]) -> HTMLLabelElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [any CSS]) -> HTMLLabelElement {
...
public func label(@HTMLBuilder content: () -> [any HTML] = { [] }) -> HTMLLabelElement { HTMLLabelElement(content: content) }
