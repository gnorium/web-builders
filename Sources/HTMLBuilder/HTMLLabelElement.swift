...
public struct HTMLLabelElement: HTMLElement, Sendable, CustomStringConvertible {
	...
	public func callAsFunction(@HTMLBuilder _ content: () -> [HTML]) -> HTMLLabelElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [CSS]) -> HTMLLabelElement {
...
public func label(@HTMLBuilder _ content: () -> [HTML] = { [] }) -> HTMLLabelElement { HTMLLabelElement(content: content) }
