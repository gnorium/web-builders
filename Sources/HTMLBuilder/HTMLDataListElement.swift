...
public struct HTMLDataListElement: HTMLElementProtocol, Sendable, CustomStringConvertible {
	...
	public func callAsFunction(@HTMLBuilder content: () -> [any HTMLProtocol]) -> HTMLDataListElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [any CSSProtocol]) -> HTMLDataListElement {
...
public func datalist(@HTMLBuilder content: () -> [any HTMLProtocol] = { [] }) -> HTMLDataListElement {
