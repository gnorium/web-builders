...
public struct HTMLObjectElement: HTMLElement, Sendable, CustomStringConvertible {
	...
	public func callAsFunction(@HTMLBuilder _ content: () -> [HTML]) -> HTMLObjectElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [CSS]) -> HTMLObjectElement {
...
public func object(@HTMLBuilder _ content: () -> [HTML] = { [] }) -> HTMLObjectElement {
