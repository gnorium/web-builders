...
public struct HTMLTableElement: HTMLElement, Sendable, CustomStringConvertible {
	...
	public func callAsFunction(@HTMLBuilder _ content: () -> [HTML]) -> HTMLTableElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [CSS]) -> HTMLTableElement {
...
public func table(@HTMLBuilder _ content: () -> [HTML] = { [] }) -> HTMLTableElement { HTMLTableElement(content: content) }
