...
public struct HTMLLegendElement: HTMLElementProtocol, Sendable, CustomStringConvertible {
	...
	public func callAsFunction(@HTMLBuilder content: () -> [any HTMLProtocol]) -> HTMLLegendElement {
	...
	public func style(prefix: Bool = true, @CSSBuilder _ content: () -> [any CSSProtocol]) -> HTMLLegendElement {
...
public func legend(@HTMLBuilder content: () -> [any HTMLProtocol] = { [] }) -> HTMLLegendElement {
