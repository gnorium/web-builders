...
extension SVG.SVGTSpanElement: SVGTextContentElementAttributes {
...
public func tspan(_ value: String) -> SVG.SVGTSpanElement { SVG.SVGTSpanElement(value) }
public func tspan(@SVGBuilder _ content: () -> [DOM.Node] = { [] }) -> SVG.SVGTSpanElement {
  SVG.SVGTSpanElement(content: content)
}
