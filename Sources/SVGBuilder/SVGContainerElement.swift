...
public class SVGContainerElement: SVG.SVGElement, SVGGraphicsElementBuildable, @unchecked Sendable {
  public init(name: String, @SVGBuilder content: () -> [DOM.Node] = { [] }) {
    super.init(name, children: content())
  }

  public init(name: String, @HTMLBuilder htmlContent: () -> [DOM.Node]) {
...
public func switch_SVG(@SVGBuilder _ content: () -> [DOM.Node] = { [] }) -> SVGContainerElement {
  SVGContainerElement(name: "switch", content: content)
}

/// Factory function for foreignObject element (SVGContent content)
public func foreignObject(@SVGBuilder _ content: () -> [DOM.Node] = { [] }) -> SVGContainerElement {
  SVGContainerElement(name: "foreignObject", content: content)
}

/// Factory function for foreignObject element (HTMLContent content)
public func foreignObject(@HTMLBuilder htmlContent: () -> [DOM.Node]) -> SVGContainerElement {
