...
extension SVG {
  public class SVGFEOffsetElement: SVGElement, SVGFilterPrimitiveStandardAttributes, @unchecked Sendable {
    public init() { super.init("feOffset") }
    public override init(id: Int32) { super.init(id: id) }
  }
}

extension SVG.SVGFEOffsetElement {
...
public func feOffset() -> SVG.SVGFEOffsetElement { SVG.SVGFEOffsetElement() }
