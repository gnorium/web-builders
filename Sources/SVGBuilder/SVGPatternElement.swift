...
extension SVGPatternElement {
  public func patternUnits(_ value: SVGUnitTypes) -> Self {
    addingAttribute("patternUnits", value.rawValue)
  }
  public func patternContentUnits(_ value: SVGUnitTypes) -> Self {
    addingAttribute("patternContentUnits", value.rawValue)
  }
...
public func pattern(@SVGBuilder content: () -> [Node] = { [] }) -> SVGPatternElement {
