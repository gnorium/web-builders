...
extension SVG {
  public class SVGEllipseElement: SVGElement, SVGGraphicsElementBuildable, @unchecked Sendable {
    public init() { super.init("ellipse") }
    public override init(id: Int32) { super.init(id: id) }
  }
}

extension SVG.SVGEllipseElement {
  ...
  public func cx(_ value: Float) -> Self { addingAttribute("cx", "\(doubleToString(Double(value)))px") }
  ...
  public func cy(_ value: Float) -> Self { addingAttribute("cy", "\(doubleToString(Double(value)))px") }
  ...
  public func rx(_ value: Float) -> Self { addingAttribute("rx", "\(doubleToString(Double(value)))px") }
  ...
  public func ry(_ value: Float) -> Self { addingAttribute("ry", "\(doubleToString(Double(value)))px") }
}

public func ellipse() -> SVG.SVGEllipseElement { SVG.SVGEllipseElement() }
