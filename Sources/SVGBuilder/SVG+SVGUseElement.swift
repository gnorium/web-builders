...
extension SVG {
  public class SVGUseElement: SVGElement, SVGGraphicsElementBuildable, @unchecked Sendable {
    public init() { super.init("use") }
    public override init(id: Int32) { super.init(id: id) }
  }
}

extension SVG.SVGUseElement {
...
public func use() -> SVG.SVGUseElement { SVG.SVGUseElement() }
