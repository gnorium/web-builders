...
extension SVG {
  public class SVGLineElement: SVGElement, SVGGraphicsElementBuildable, @unchecked Sendable {
    public init() { super.init("line") }
    public override init(id: Int32) { super.init(id: id) }
  }
}

extension SVG.SVGLineElement {
  ...
  public func x1(_ value: Float) -> Self { addingAttribute("x1", "\(doubleToString(Double(value)))px") }
  ...
  public func y1(_ value: Float) -> Self { addingAttribute("y1", "\(doubleToString(Double(value)))px") }
  ...
  public func x2(_ value: Float) -> Self { addingAttribute("x2", "\(doubleToString(Double(value)))px") }
  ...
  public func y2(_ value: Float) -> Self { addingAttribute("y2", "\(doubleToString(Double(value)))px") }
}

public func line() -> SVG.SVGLineElement { SVG.SVGLineElement() }
