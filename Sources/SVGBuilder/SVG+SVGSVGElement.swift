...
extension SVG.SVGSVGElement {
  ...
  public func gradientTransform(_ value: SVG.Transform) -> Self {
...
public func svg(@SVGBuilder _ content: () -> [DOM.Node] = { [] }) -> SVG.SVGSVGElement {
  SVG.SVGSVGElement(content: content)
}
