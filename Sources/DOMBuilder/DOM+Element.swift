...
extension DOM {
  open class Element: Node, @unchecked Sendable {
    ...
    public override var nodeType: HTML.NodeType { .elementNode }
...
public var outerHTML: String {
      ...
      open var scrollHeight: Double { element_getScrollHeight(id) }
      ...
      open func scrollTo(x: Double, y: Double) { element_scrollTo(id, x, y) }
      ...
      public func beginElement() { element_beginElement(id) }

      public func endElement() { element_endElement(id) }
    #endif
  }
}
