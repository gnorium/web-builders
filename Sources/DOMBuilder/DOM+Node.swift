...
extension DOM {
  open class Node: DOMNodeConvertible, CustomStringConvertible, @unchecked Sendable {
    public var description: String {
      return render()
    }
    public static func fragment(@DOMBuilder _ content: () -> [DOM.Node]) -> DocumentFragment {
    ...
    public func build() -> DOM.Node { self }
    public let id: Int32
